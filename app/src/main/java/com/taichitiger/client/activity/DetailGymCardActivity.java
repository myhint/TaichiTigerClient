...
public class DetailGymCardActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_gym_card);
        ButterKnife.bind(this);

        toolbar.setTitle(R.string.title_detail_gym_card);
        ...
        adapter.addHeader(1, R.layout.header_detail_gym_card);
